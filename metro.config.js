...
config.resolver = {
  ...
  resolveRequest: (context, moduleName, platform) => {
    // Fix engine.io-client parseqs resolution (socket.io-client dependency)
    if (
      moduleName.endsWith("contrib/parseqs.js") ||
      moduleName.includes("contrib/parseqs")
    ) {
      const path = require("path");
      const parseqsPath = path.resolve(
        __dirname,
        "node_modules/engine.io-client/build/esm/contrib/parseqs.js"
      );
      return { type: "sourceFile", filePath: parseqsPath };
    }
